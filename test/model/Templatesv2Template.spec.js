...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FormAPI.Templatesv2Template();
  });
  ...
  describe('Templatesv2Template', function() {
    it('should create an instance of Templatesv2Template', function() {
      // uncomment below and update the code to test Templatesv2Template
      //var instance = new FormAPI.Templatesv2Template();
      //expect(instance).to.be.a(FormAPI.Templatesv2Template);
    });
