...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FormAPI.CreateSubmissionDataRequestData();
  });
  ...
  describe('CreateSubmissionDataRequestData', function() {
    it('should create an instance of CreateSubmissionDataRequestData', function() {
      ...
      //var instance = new FormAPI.CreateSubmissionDataRequestData();
      //expect(instance).to.be.a(FormAPI.CreateSubmissionDataRequestData);
    });
