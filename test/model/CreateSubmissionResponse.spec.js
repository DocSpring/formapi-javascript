...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FormAPI.CreateSubmissionResponse();
  });
  ...
  describe('CreateSubmissionResponse', function() {
    it('should create an instance of CreateSubmissionResponse', function() {
      ...
      //var instance = new FormAPI.CreateSubmissionResponse();
      //expect(instance).to.be.a(FormAPI.CreateSubmissionResponse);
    });
