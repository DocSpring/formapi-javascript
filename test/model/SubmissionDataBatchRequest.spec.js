...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FormAPI.SubmissionDataBatchRequest();
  });
  ...
  describe('SubmissionDataBatchRequest', function() {
    it('should create an instance of SubmissionDataBatchRequest', function() {
      ...
      //var instance = new FormAPI.SubmissionDataBatchRequest();
      //expect(instance).to.be.a(FormAPI.SubmissionDataBatchRequest);
    });
